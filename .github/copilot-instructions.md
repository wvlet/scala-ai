...
- uni project is a cross-build project. To add JVM/JS/Native specific code, use .jvm, .js, and .native folders respectively.
  - uni is designed to have minimal dependencies. Avoid using libraries that are not in the core module.
