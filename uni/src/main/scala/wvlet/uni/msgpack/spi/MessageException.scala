...
object MessageException:
  ...
  def overflowU32(u32: Int) =
    new IntegerOverflowException(BigInteger.valueOf((u32 & 0xffffffff).toLong))

  def overflowU64(u64: Long) =
    new IntegerOverflowException(BigInteger.valueOf(u64 + Long.MaxValue + 1L).setBit(63))
  ...
  def overflowU32Size(u32: Int) =
    new TooLargeMessageException(((u32 & 0x7fffffff) + 0x80000000L).toLong)
