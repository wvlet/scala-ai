...
object Scala3NewTypeTest extends AirSpec:
  ...
  test("support intersection type") {
    ...
    s.fullName shouldBe "java.lang.String&wvlet.uni.core.surface.Scala3NewTypeTest.Label1"
  ...
  test("opaque types") {
    ...
    s.fullName shouldBe "wvlet.uni.core.surface.Scala3NewTypeTest.MyEnv"
    s shouldNotBe Surface.of[String]
