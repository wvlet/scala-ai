...
import wvlet.uni.core.util.LazyF0
...
trait RxOps[+A]:
  ...
  /**
    ...
    *   the original Rx event
    */
  def tap(f: A => Unit): Rx[A] = tapOn({ case Success(v) =>
    f(v)
  })
  ...
  /**
    ...
    *   the original Rx event
    */
  def tapOnFailure(f: Throwable => Unit): Rx[A] = tapOn({ case Failure(e) =>
    f(e)
  })

  /**
    * Evaluate this Rx[A] and apply the given effect function. Once OnError(e) or OnCompletion is
    * observed, it will stop the evaluation.
    *
    * @param effect
    * @tparam U
    * @return
  ...
  /**
    * Keep evaluating Rx[A] even if OnError(e) or OnCompletion is reported. This is useful for keep
    * processing streams.
    */
  ...
  /**
    ...
    *
    * Note: Generally speaking, blocking operations should be avoided in reactive programming. Use
    * this method only for testing purpose. Both airframe-http and AirSpec supports evaluating Rx[X]
    * result (async) in a non-blocking way.
    * @return
    *   the result
    */
...
trait Rx[+A] extends RxOps[A]:
  ...
  /**
    ...
    */
  def toSeq: Seq[A] = compat.toSeq(this)
  ...
  /**
    * Applies `f` to the input value that produces another Rx stream. This method is an alias of
    * flatMap(f)
    * @param f
    * @tparam B
    * @return
  ...
  /**
    * Combine two Rx streams to form a sequence of pairs. This will emit a new pair when both of the
    * streams are updated.
    */
  def zip[B](other: RxOps[B]): Rx[(A, B)] = Rx.zip(this, other)

  /**
    * Combine three Rx streams to form a sequence of triples. This will emit a new triple when all
    * of the streams are updated.
    * @param b
    * @param c
    * @tparam B
    * @tparam C
  ...
  /**
    * Combine four Rx streams to form a sequence of quadruples. This will emit a new quadruple when
    * all of the streams are updated.
    * @param b
    * @param c
    * @param d
    * @tparam B
  ...
  /**
    * Combine five Rx streams to form a sequence of quintuples. This will emit a new quintuple when
    * all of the streams are updated.
    * @param b
    * @param c
    * @param d
    ...
    * @return
    */
  def zip[B, C, D, E](b: RxOps[B], c: RxOps[C], d: RxOps[D], e: RxOps[E]): Rx[(A, B, C, D, E)] = Rx
    .zip(this, b, c, d, e)
  ...
  def zip[B, C, D, E, F](
      ...
      e: RxOps[E],
      f: RxOps[F]
  ): Rx[(A, B, C, D, E, F)] = Rx.zip(this, b, c, d, e, f)
  ...
  def zip[B, C, D, E, F, G](
      ...
      f: RxOps[F],
      g: RxOps[G]
  ): Rx[(A, B, C, D, E, F, G)] = Rx.zip(this, b, c, d, e, f, g)
  ...
  def zip[B, C, D, E, F, G, H](
      ...
      g: RxOps[G],
      h: RxOps[H]
  ): Rx[(A, B, C, D, E, F, G, H)] = Rx.zip(this, b, c, d, e, f, g, h)
  ...
  def zip[B, C, D, E, F, G, H, I](
      ...
      h: RxOps[H],
      i: RxOps[I]
  ): Rx[(A, B, C, D, E, F, G, H, I)] = Rx.zip(this, b, c, d, e, f, g, h, i)
  ...
  def zip[B, C, D, E, F, G, H, I, J](
      ...
      i: RxOps[I],
      j: RxOps[J]
  ): Rx[(A, B, C, D, E, F, G, H, I, J)] = Rx.zip(this, b, c, d, e, f, g, h, i, j)
  ...
  /**
    ...
    *
    * Using joins will be more intuitive than nesting multiple Rx operators like Rx[A].map { x =>
    * ... Rx[B].map { ...} }.
    */
  ...
  /**
    ...
    * @return
    */
  def join[B, C, D](b: RxOps[B], c: RxOps[C], d: RxOps[D]): Rx[(A, B, C, D)] = Rx.join(
    this,
    b,
    c,
    d
  ...
  /**
    ...
    * @return
    */
  def join[B, C, D, E](b: RxOps[B], c: RxOps[C], d: RxOps[D], e: RxOps[E]): Rx[(A, B, C, D, E)] = Rx
    .join(this, b, c, d, e)
  ...
  def join[B, C, D, E, F](
      ...
      e: RxOps[E],
      f: RxOps[F]
  ): Rx[(A, B, C, D, E, F)] = Rx.join(this, b, c, d, e, f)
  ...
  def join[B, C, D, E, F, G](
      ...
      f: RxOps[F],
      g: RxOps[G]
  ): Rx[(A, B, C, D, E, F, G)] = Rx.join(this, b, c, d, e, f, g)

  /**
    * Emit a new output if one of Rx[A], Rx[B], Rx[C], Rx[D], Rx[E], Rx[F], Rx[G], or Rx[H] is
    * changed.
    * @param b
    * @param c
    * @param d
  ...
  def join[B, C, D, E, F, G, H](
      ...
      g: RxOps[G],
      h: RxOps[H]
  ): Rx[(A, B, C, D, E, F, G, H)] = Rx.join(this, b, c, d, e, f, g, h)

  /**
    * Emit a new output if one of Rx[A], Rx[B], Rx[C], Rx[D], Rx[E], Rx[F], Rx[G], Rx[H], or Rx[I]
    * is changed.
    * @param b
    * @param c
    * @param d
  ...
  def join[B, C, D, E, F, G, H, I](
      ...
      h: RxOps[H],
      i: RxOps[I]
  ): Rx[(A, B, C, D, E, F, G, H, I)] = Rx.join(this, b, c, d, e, f, g, h, i)

  /**
    * Emit a new output if one of Rx[A], Rx[B], Rx[C], Rx[D], Rx[E], Rx[F], Rx[G], Rx[H], Rx[I], or
    * Rx[J] is changed.
    * @param b
    * @param c
    * @param d
  ...
  def join[B, C, D, E, F, G, H, I, J](
      ...
      i: RxOps[I],
      j: RxOps[J]
  ): Rx[(A, B, C, D, E, F, G, H, I, J)] = Rx.join(this, b, c, d, e, f, g, h, i, j)

  /**
    * Combine Rx stream and Future operators.
    *
    * This method is useful when you need to call RPC multiple times and chain the next operation
    ...
    * }}}
    */
  def andThen[B](f: A => Future[B])(implicit ex: ExecutionContext): Rx[B] = this.flatMap(a =>
    Rx.future(f(a))
  )

  /**
    * Transform the input value by wrapping it with Try regardless of success or failure. This is
    * useful when you need to handle both success and failure cases in the same way.
    */
  def transformRx[B](f: Try[A] => RxOps[B]): Rx[B] = TransformRxOp(this, f)
  ...
  /**
    ...
    * @return
    */
  def transform[B](f: Try[A] => B): Rx[B] = TransformOp(this, f)

  /**
    * Transform the input value by wrapping it with Try regardless of success or failure. This is
    * useful when you need to add a post-processing step after handling success and failure cases.
    */
  def transformTry[B](f: Try[A] => Try[B]): Rx[B] = TransformTryOp(this, f)

  /**
    * Transform a specific type of an exception into another exception. This is useful for handling
    * exceptions.
    * @param f
    * @return
    */
  def transformFailure(f: PartialFunction[Throwable, Throwable]): Rx[A] = transformTry[A] {
    case Failure(ex) if f.isDefinedAt(ex) =>
      Failure(f.apply(ex))
    case other =>
      other
  }
  ...
  /**
    ...
    *
    * The cached value will be preserved to the operator itself even after cancelling the
    * subscription. Re-subscription of this operator will immediately return the cached value to the
    * downstream operator.
    *
    * This operator is useful if we need to involve time-consuming process, and want to reuse the
    * last result: <code> val v = Rx.intervalMillis(1000).map(i => (heavy process)).cache
    *
    * v.map { x => ... } </code>
    */
  ...
  /**
    * Take an event up to <i>n</i> elements. This may receive fewer events than n if the upstream
    * operator completes before generating <i>n</i> elements.
    */
  def take(n: Long): Rx[A] = TakeOp(this, n)

  /**
    * Emit the first item of the source within each sampling period. For example, this is useful to
    * prevent double-clicks of buttons.
    */
  ...
  /**
    * Emit the most recent item of the source within periodic time intervals.
    */
  def sample(timeWindow: Long, unit: TimeUnit = TimeUnit.MILLISECONDS): Rx[A] = ThrottleLastOp[A](
    this,
    timeWindow,
    unit
  )
...
object Rx extends LogSupport:
  ...
  /**
    * Create a lazily evaluated single value. A difference from Rx.const is that the value will be
    * evaluated only when the value is requested.
    */
  ...
  def join[A, B, C, D, E](
      ...
      d: RxOps[D],
      e: RxOps[E]
  ): Rx[(A, B, C, D, E)] = Join5Op(a, b, c, d, e)
  ...
  def join[A, B, C, D, E, F](
      ...
      e: RxOps[E],
      f: RxOps[F]
  ): Rx[(A, B, C, D, E, F)] = Join6Op(a, b, c, d, e, f)
  ...
  def join[A, B, C, D, E, F, G](
      ...
      f: RxOps[F],
      g: RxOps[G]
  ): Rx[(A, B, C, D, E, F, G)] = Join7Op(a, b, c, d, e, f, g)
  ...
  def join[A, B, C, D, E, F, G, H](
      ...
      g: RxOps[G],
      h: RxOps[H]
  ): Rx[(A, B, C, D, E, F, G, H)] = Join8Op(a, b, c, d, e, f, g, h)
  ...
  def join[A, B, C, D, E, F, G, H, I](
      ...
      h: RxOps[H],
      i: RxOps[I]
  ): Rx[(A, B, C, D, E, F, G, H, I)] = Join9Op(a, b, c, d, e, f, g, h, i)
  ...
  def join[A, B, C, D, E, F, G, H, I, J](
      ...
      i: RxOps[I],
      j: RxOps[J]
  ): Rx[(A, B, C, D, E, F, G, H, I, J)] = Join10Op(a, b, c, d, e, f, g, h, i, j)
  ...
  def zip[A, B, C, D, E, F](
      ...
      e: RxOps[E],
      f: RxOps[F]
  ): Rx[(A, B, C, D, E, F)] = Zip6Op(a, b, c, d, e, f)
  ...
  def zip[A, B, C, D, E, F, G](
      ...
      f: RxOps[F],
      g: RxOps[G]
  ): Rx[(A, B, C, D, E, F, G)] = Zip7Op(a, b, c, d, e, f, g)
  ...
  def zip[A, B, C, D, E, F, G, H](
      ...
      g: RxOps[G],
      h: RxOps[H]
  ): Rx[(A, B, C, D, E, F, G, H)] = Zip8Op(a, b, c, d, e, f, g, h)
  ...
  def zip[A, B, C, D, E, F, G, H, I](
      ...
      h: RxOps[H],
      i: RxOps[I]
  ): Rx[(A, B, C, D, E, F, G, H, I)] = Zip9Op(a, b, c, d, e, f, g, h, i)
  ...
  def zip[A, B, C, D, E, F, G, H, I, J](
      ...
      i: RxOps[I],
      j: RxOps[J]
  ): Rx[(A, B, C, D, E, F, G, H, I, J)] = Zip10Op(a, b, c, d, e, f, g, h, i, j)
  ...
  /**
    * Periodically trigger an event and report the interval millis. After running Rx with an
    * interval, the cancel method must be called to stop the timer: <code> val c =
  ...
  /**
    ...
    *
    * The difference from Rx.future is that this method can observe the waiting state of the Future
  ...
  case class RecoverOp[A, U](input: RxOps[A], f: PartialFunction[Throwable, U])
      extends UnaryRx[A, U]
